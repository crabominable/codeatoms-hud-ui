...
-----------------------------------------------------------------------------------------------------------------------------------------
cRP = {}
Tunnel.bindInterface("CODEATOMS-HUD",cRP)
vSERVER = Tunnel.getInterface("CODEATOMS-HUD")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local ped = 0
...
-- UPDATETALKING
-----------------------------------------------------------------------------------------------------------------------------------------
AddEventHandler("CODEATOMS-HUD:VoiceTalking",function(status)
	talking = status
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- PROGRESS
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("CODEATOMS-HUD:update")
AddEventHandler("CODEATOMS-HUD:update", function(rHunger, rThirst)
...
-- HOOD
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("CODEATOMS-HUD:toggleHood")
AddEventHandler("CODEATOMS-HUD:toggleHood",function()
...
RegisterNetEvent("CODEATOMS-HUD:discordTrue")
AddEventHandler("CODEATOMS-HUD:discordTrue",function()
...
RegisterNetEvent("CODEATOMS-HUD:discordFalse")
AddEventHandler("CODEATOMS-HUD:discordFalse",function(status)
	if discordHood then
		discordHood = false
		SendNUIMessage({ hood = false })
	end
...
-- TOKOVOIP
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("CODEATOMS-HUD:VoiceMode")
AddEventHandler("CODEATOMS-HUD:VoiceMode",function(status)
	voice = status
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- TOKOVOIP
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("CODEATOMS-HUD:RadioDisplay")
AddEventHandler("CODEATOMS-HUD:RadioDisplay",function(number)
...
-- SYNCTIMERS
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("CODEATOMS-HUD:syncTimers")
AddEventHandler("CODEATOMS-HUD:syncTimers",function(timer)
